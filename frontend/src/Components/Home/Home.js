    ...
    return (
      <>
        ...
        <div className='Invitations'>
          <button onClick={showHideInvites} className='invitations-button'>View Invitations
          </button>
        {showInvitations && <Invitations token={token} userId={userId}/>}
